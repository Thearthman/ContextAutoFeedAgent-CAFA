...
# Model configuration
MODEL_NAME = "Qwen/Qwen2-VL-7B-Instruct"  # Start with 7B for testing, can switch to 30B
# Note: Qwen2-VL-30B-Instruct-AWQ or quantized variants recommended for RTX 5090
...
def initialize_agent():
    ...
    print("=" * 70)
    print("🚀 Starting Qwen Agent Server...")
    print("=" * 70)
    print(f"Loading model: {MODEL_NAME}")
    start_time = time.time()
    
    try:
        # Configure quantization for RTX 5090
